...
+ (void)use_RACTuple {
    ...
    // 3.字典转模型
    NSString *filePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"flags.plist" ofType:nil];
    ...
    NSArray *flags3 = [[dictArr.rac_sequence map:^id(id value) {
